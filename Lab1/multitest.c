...
volatile bool chirp_core_1 = true;
...
bool repeating_timer_callback_core_1(struct repeating_timer *t) {
    ...
    if (STATE_1 == 0) {
        ...
        // Ramp down amplitude
        else if (count_1 > SYLL_LENGTH - DECAY_TIME) {
        ...
        if (count_1 == SYLL_LENGTH) {
            ...
            if (syll_count_1 != 8){
                STATE_1 = 1 ;
                count_1 = 0 ;
                //printf("Transition from Chirp to Syllable Pause - count1: %d, syllable_count_1:%d\n", count_1,syll_count_1) ;
            }
            // State transition: Transition from Chirp to Chirp Pause
            else{
                STATE_1 = 2;
                count_1 = 0;
                //printf("Transition from Chirp to Chirp Pause - count1: %d, syllable_count_1:%d\n", count_1,syll_count_1) ;
            }
        }
    }
        ...
        if (count_1 == SYLL_REPEAT_INTERVAL) {
            ...
            STATE_1 = 0 ;
            count_1 = 0 ;
            //printf("Transition from Syllable Pause to Chirp - count1: %d, syllable_count_1:%d\n", count_1,syll_count_1) ;
        }  
    }
        ...
        if (count_1 == CHIRP_REPEAT_INTERVAL) {
            ...
            count_1 = 0 ;
            syll_count_1 = 0;
            //printf("Transition from Chirp Pause to Chirp - count1: %d, syllable_count_1:%d\n", count_1,syll_count_1) ;
        }
    }
...
bool repeating_timer_callback_core_0(struct repeating_timer *t) {
    ...
    if (STATE_0 == 0) {
        ...
        // Ramp down amplitude
        else if (count_0 > SYLL_LENGTH - DECAY_TIME) {
        ...
        if (count_0 == SYLL_LENGTH) {
            ...
            if (syll_count_0 != 8){
                STATE_0 = 1 ;
                count_0 = 0 ;
                //printf("Transition from Chirp to Syllable Pause - count0: %d, syllable_count_0:\n", count_0,syll_count_0) ;
            }
            // State transition: Transition from Chirp to Chirp Pause
            else{
                STATE_0 = 2;
                count_0 = 0;
                //printf("Transition from Chirp to Chirp Pause - count0: %d, syllable_count_0:\n", count_0,syll_count_0) ;
            }
        }
    }
    ...
    // State transition?
        ...
        if (count_0 == SYLL_REPEAT_INTERVAL) {
            ...
            STATE_0 = 0 ;
            count_0 = 0 ;
            //printf("Transition from Syllable Pause to Chirp - count0: %d, syllable_count_0:\n", count_0,syll_count_0) ;
        }  
    }
        ...
        if (count_0 == CHIRP_REPEAT_INTERVAL) {
            ...
            count_0 = 0 ;
            syll_count_0 = 0;
            //printf("Transition from Chirp Pause to Chirp - count0: %d, syllable_count_0:\n", count_0,syll_count_0) ;
        }
    }
